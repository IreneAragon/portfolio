            ...
            <div className={styles.infoContainer}>
                ...
                <div className={styles.contactInfoContainer}>
                    <div className={styles.contactInfoElement}>
                        ...
                        <a href='mailto:irenearagongomez@gmail.com'>irenearagongomez@gmail.com</a>
                    </div>
                    <div className={styles.contactInfoElement}>
                        <svg xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='30' height='30' viewBox='0 0 50 50'>
                        ...
                        <a href='https://www.linkedin.com/in/irene-aragon/' rel='noopener noreferrer' target='_blank' aria-label='Página de linkedin. Se abrirá en una nueva pestaña'>linkedin.com/in/irene-aragon/</a>
                    </div>
                    <div className={styles.contactInfoElement}>
                        <svg xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' width='30' height='30' viewBox='0 0 50 50'>
                        ...
                        <a href='https://github.com/IreneAragon' rel='noopener noreferrer' target='_blank' aria-label='Página de github. Se abrirá en una nueva pestaña'>github.com/IreneAragon</a>
                    </div>
                </div>
            </div>
